 ...
 * @author luuka
 */
public class UpdateTrainerAction extends ActionSupport {
    ...
    public Trainer getTn() {
        return tn;
    }

    public void setTn(Trainer tn) {
        this.tn = tn;
    }
    ...
    public UpdateTrainerAction() {
    }

    public String execute() throws Exception {
        UpdateProcess up = new UpdateProcess();
        if (up.getTrainerById(trainerId)!=null) {
            tn = up.getTrainerById(trainerId);
            return "success";
        }
        return "fail";
    }
    ...
    public String doUpdate() throws Exception {
        UpdateProcess up = new UpdateProcess();
        if (up.updateTrainer(trainerId, trainerName, trainerDOB, trainerEmail, trainerPhone, trainerAddress, trainerDes, trainerGender)) {
